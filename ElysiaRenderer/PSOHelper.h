...
namespace ElysiaHelper
{
    ...
    inline D3D12_BLEND_DESC GetBlendState(BlendState blendState)
    {
    ...
    inline D3D12_RASTERIZER_DESC GetRasterizerState(RasterizerState rasterizerState)
    {
