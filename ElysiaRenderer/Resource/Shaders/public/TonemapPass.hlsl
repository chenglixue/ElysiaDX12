...
PSOutput PS(PSInput i)
{
    ...
    float4 linearColor = blitterValue;
    
    float3 tonemapColor = NeutralTonemap(linearColor);
    tonemapColor = ToneMapFilmicALU(linearColor);
    //tonemapColor = uncharted2_filmic(linearColor);
