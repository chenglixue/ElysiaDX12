...
{
    DX12TextureResource::DX12TextureResource(ComPtr<ID3D12Resource> resource, D3D12_RESOURCE_STATES usageState) :
    ...
    DX12TextureResource::DX12TextureResource(ComPtr<ID3D12Resource> resource,
