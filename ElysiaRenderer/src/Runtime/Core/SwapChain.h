...
namespace ElysiaCore
{
    ...
    public:
        ...
        void OnCreateWindowSizeDependentResources(uint32_t dwWidth,
                                                  uint32_t dwHeight,
                                                  bool bVSyncOn,
                                                  DisplayMode displayMode = DISPLAYMODE_SDR,
        ...
        void EnumerateDisplayModes(std::vector<DisplayMode>* pModes,
    ...
    private:
        ...
        HWND m_hWnd = NULL;
        const uint32_t m_BackBufferCount = ElysiaHelper::NUM_BACK_BUFFERS;
        ...
        std::array<std::unique_ptr<DX12TextureResource>, ElysiaHelper::NUM_BACK_BUFFERS>
        m_backBuffers;
