...
namespace ElysiaCore
{
    ...
    public:
        ...
        UINT GetFrameID() const noexcept
        {
            return m_frameID;
        }
        ...
        void CopyDescriptors(uint32_t numDestDescriptorRanges,
        ...
        UINT AllocateContiguousReservedDescriptorIndices(UINT count);
        void FreeContiguousReservedDescriptorIndices(UINT baseIndex, UINT count);
    ...
    private:
        ...
        std::array<std::vector<std::pair<uint64_t, D3D12_COMMAND_LIST_TYPE>>, NUM_FRAMES_IN_FLIGHT>
        m_contextSubmissions;
