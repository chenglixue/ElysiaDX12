...
namespace ElysiaCore
{
    ...
    struct ShaderReflectionData
    {
        ...
        void Merge(ShaderReflectionData& data)
        {
            ...
            if (data.ThreadGroupSize.IsValid())
            {
                ThreadGroupSize = data.ThreadGroupSize;
            }
        }
    ...
    public:
        ...
        ShaderVariantData(const ShaderVariantData& other)
            : KeywordSet(other.KeywordSet),
              ...
              pMeshResourceLayout(other.pMeshResourceLayout
                                      ? std::make_unique<PipelineResourceLayout>(*other.pMeshResourceLayout)
                                      : nullptr)
        {
        }
        ...
        ShaderVariantData& operator=(const ShaderVariantData& rhs)
        {
            if (this != &rhs)
            {
                ...
                pMeshResourceLayout = rhs.pMeshResourceLayout
                                          ? std::make_unique<PipelineResourceLayout>(*rhs.pMeshResourceLayout)
                                          : nullptr;
            }
            return *this;
        }
