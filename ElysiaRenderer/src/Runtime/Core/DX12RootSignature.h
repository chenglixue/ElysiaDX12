...
namespace ElysiaCore
{
    ...
    public:
        ...
        void InitAsConstantBufferView(UINT slotIndex,
                                      D3D12_SHADER_VISIBILITY shaderVisibility = D3D12_SHADER_VISIBILITY_ALL,
                                      UINT Space = 0);
        ...
        void InitAsDescriptorTable(UINT rangeCount,
                                   ...
                                   D3D12_SHADER_VISIBILITY shaderVisibility = D3D12_SHADER_VISIBILITY_ALL);
        void SetTableRange(D3D12_DESCRIPTOR_RANGE_TYPE rangeType,
                           UINT numDescriptors,
                           UINT slotIndex,
                           UINT rangeIndex,
    ...
    public:
        ...
        void InitStaticSamplers(UINT slotIndex,
    ...
    private:
        ...
        // Non-sampler descriptor tables need to know their descriptor count. one index for one root parameter
    };
}