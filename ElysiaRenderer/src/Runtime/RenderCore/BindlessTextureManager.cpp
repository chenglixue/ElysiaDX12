...
namespace ElysiaRenderer
{
        ...
        std::wstring name)
    {
        ...
        std::vector<D3D12_RESOURCE_STATES> usageStates{desc.MipLevels, usageState};
        auto newTex = std::make_unique<DX12TextureResource>(texResource, usageStates, allocation);
